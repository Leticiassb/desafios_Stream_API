# Resolvendo desafios em Java com Stream API

### Repositório criado a partir do repósitorio [Ganhando Produtividade com Stream API Java](https://github.com/digitalinnovationone/ganhando_produtividade_com_Stream_API_Java)
